...
export default async function Page() {
  ...
  if (isRootDomain || !slug) {
    // Render your original marketing homepage
    return (
      <div className="bg-gray-50 text-gray-800">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 text-center">
          ...
          <p className="text-gray-600">
            Recent Florida legislation mandates that certain homeowners associations provide access to governing
            documents, meeting notices, budgets, and more via a community-specific website. Non-compliance could
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Sun State HOA provides fully managed websites tailored for your community. Our service ensures you
              meet all Florida HOA digital compliance standards — without the headache or high costs.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Contact us today to learn how we can help your HOA meet Florida’s legal website requirements — quickly
            and affordably.
          </p>
          <a
            href="/contact"
  ...
  // Else, render tenant-specific landing
  ...
  if (!tenant) {
    return (
      <main className="p-10 text-center">
        <h1 className="text-2xl font-bold text-red-600 mb-2">Invalid HOA Subdomain</h1>
        <p className="text-gray-600">We couldn't find a registered HOA at this address.</p>
      </main>
    );
  }
  ...
  return (
    <main className="max-w-2xl mx-auto p-10 text-center">
      {tenant.logo_url && (
        <img src={tenant.logo_url} alt={`${tenant.name} logo`} className="mx-auto h-20 mb-4" />
      )}
      <h1 className="text-4xl font-bold mb-2">{tenant.name}</h1>
      <p className="text-gray-600 text-lg">
        {tenant.description || 'Welcome to your HOA portal.'}
      </p>
    </main>
  );
}
